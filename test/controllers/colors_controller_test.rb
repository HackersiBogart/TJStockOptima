...
class ColorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create color" do
    assert_difference("Color.count") do
      post colors_url, params: { color: { code_color: @color.code_color, image_color: @color.image_color, name_color: @color.name_color } }
    end
  ...
  test "should update color" do
    patch color_url(@color), params: { color: { code_color: @color.code_color, image_color: @color.image_color, name_color: @color.name_color } }
