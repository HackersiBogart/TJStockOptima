...
class PreordersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preorder" do
    assert_difference("Preorder.count") do
      post preorders_url, params: { preorder: { color: @preorder.color, quantity: @preorder.quantity, target_date: @preorder.target_date } }
    end
  ...
  test "should update preorder" do
    patch preorder_url(@preorder), params: { preorder: { color: @preorder.color, quantity: @preorder.quantity, target_date: @preorder.target_date } }
